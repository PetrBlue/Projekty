...
namespace hangmanxd
    {
        ...
        {   // checking for word 
            ...
            static void GetAlphabet(string letters)
            {
                ...
                Console.WriteLine("Zbývající Písmena:");
            ...
            static void Main()
            {
                ...
                while (live > 0)
                {
                    ...
                    if (IsWord(secretword, letterGuessed))
                    {
                        ...
                        Console.WriteLine("Slovo bylo uhádnuto!");
                        break;
                    }
                    ...
                    {
                        Console.ForegroundColor = ConsoleColor.Magenta;
                        Console.WriteLine("Správné Písmeno :D");
                        Console.ForegroundColor = ConsoleColor.Yellow;
                    ...
                    {
                        Console.ForegroundColor = ConsoleColor.Red;
                        Console.WriteLine("Špatné Písmeno :c");
                        live -= 1;
                        Console.ForegroundColor = ConsoleColor.Magenta;
                        Console.WriteLine("Máš {0} životy", live);
                    }
                    Console.WriteLine();
                    // print secret word 
                    if (live == 0)
